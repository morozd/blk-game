...
goog.provide('blk.ui.popups.Settings');
 ...
 */
blk.ui.popups.Settings = function(game, opt_domHelper, opt_parent) {
  var launchOptions = /** @type {!blk.client.LaunchOptions} */ (
      game.launchOptions);
  goog.base(this, blk.ui.popups.settings.popup, {
...
goog.inherits(blk.ui.popups.Settings, blk.ui.Popup);


/**
 * @override
 */
blk.ui.popups.Settings.prototype.enterDocument = function() {
 ...
 */
blk.ui.popups.Settings.prototype.setupSlider_ = function(
    className,
 ...
 */
blk.ui.popups.Settings.prototype.getSliderValue_ = function(className) {
  var root = this.dom.getElementByClass(className);
  if (!root) {
    return undefined;
  }
 ...
 */
blk.ui.popups.Settings.prototype.setupCheckbox_ = function(
 ...
 */
blk.ui.popups.Settings.prototype.getCheckboxValue_ = function(className) {
  var root = this.dom.getElementByClass(className);
  if (!root) {
    return undefined;
  }
 ...
 * @override
 */
blk.ui.popups.Settings.prototype.beforeClose = function(buttonId) {
  if (buttonId != 'save') {
    return;
  }
 ...
 *     parameter.
 */
blk.ui.popups.Settings.show = function(game, opt_domHelper, opt_parent) {
  var popup = new blk.ui.popups.Settings(game, opt_domHelper, opt_parent);
  popup.enterDocument();
