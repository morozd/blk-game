...
goog.provide('blk.env.blocks.StoneBlock');
 ...
 */
blk.env.blocks.StoneBlock = function() {
  goog.base(this,
      blk.env.blocks.BlockID.STONE,
      'Stone',
      blk.env.materials.stone,
      blk.env.BlockFlags.BREAKABLE | blk.env.BlockFlags.COLLIDABLE,
      1);
};
goog.inherits(blk.env.blocks.StoneBlock, blk.env.blocks.SolidBlock);
