...
goog.provide('blk.env.blocks.BrickBlock');
 ...
 */
blk.env.blocks.BrickBlock = function() {
  goog.base(this,
      blk.env.blocks.BlockID.BRICK,
      'Brick',
      blk.env.materials.stone,
      blk.env.BlockFlags.BREAKABLE | blk.env.BlockFlags.COLLIDABLE,
      7);
};
goog.inherits(blk.env.blocks.BrickBlock, blk.env.blocks.SolidBlock);
