...
goog.provide('blk.env.blocks.GlassBlock');
 ...
 */
blk.env.blocks.GlassBlock = function() {
  goog.base(this,
      blk.env.blocks.BlockID.GLASS,
      'Glass',
      blk.env.materials.glass,
      blk.env.BlockFlags.BREAKABLE | blk.env.BlockFlags.COLLIDABLE,
      49);
};
goog.inherits(blk.env.blocks.GlassBlock, blk.env.blocks.SolidBlock);
